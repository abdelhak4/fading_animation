import 'package:fading_animation/widget/app_fader_effect.dart';
import 'package:fading_animation/widget/bnb.dart';
        ...
        child: Column(
          children: [
            ...
            Animate(
              ...
              child: Text(
                "in/abdelhak-el-moussaoui",
                style: TextStyle(
                  backgroundColor: !_atBottom ? null : Colors.green,
                  color: Colors.white,
